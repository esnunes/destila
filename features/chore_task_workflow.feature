Feature: Prompt for a Chore / Task AI-Driven Workflow
  ...
  Background:
    ...
    And I have a "Prompt for a Chore / Task" session created through the wizard

  Scenario: Phase 1 - AI asks clarifying questions
    Given the session is in Phase 1 - Task Description
