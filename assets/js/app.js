...
const DestilaTerminal = {
  ...GhosttyTerminal,
  mounted() {
    GhosttyTerminal.mounted.call(this)
    const pre = this.el.querySelector("pre")
    if (pre) {
      if (this.el.dataset.bg) pre.style.backgroundColor = this.el.dataset.bg
      if (this.el.dataset.fg) pre.style.color = this.el.dataset.fg
    }
  }
}
